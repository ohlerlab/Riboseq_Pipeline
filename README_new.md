...
1. Edit [sample_config.tsv](/README_new.md#sampleconfigtsv) in the folder `/src/` to point it to your fastq files (zipped or not, either is fine) with the appropriate parameters.

2. Edit [config.yaml.](/README_new.md#configyaml)  
This is where you put in for example, the path to annotation, genome sequence, etc.
...
- Command to check *cutaddapt* worked:
    ```
